...
<div style="overflow: auto;">
  <span style="font-size: 0.8em; color: green; font-style: italic; float: left;">Compatible models: BilateralSOS and BilateralFIR</span>  
  <span style="font-size: 0.8em; color: grey; font-style: italic; float: right; margin-right: 15px;">Available from BeRTA v3.10.0</span>
</div>


This command sets the filter coefficient database for simulating the binaural filter model. It works both for setting the [filter coefficients of the second-order](../library/service-modules/service-sos-coefficients.md) section in SOS bilateral filters and the [impulse response table](../library/service-modules/service-general-fir.md) in FIR bilateral filters. 
