...
The BRIR rendering models require BRIRsF data to be preloaded and preprocessed in the BRIR service module. For more details, see the documentation on the [SpherialFIRTable service module](../../service-modules/service-spherical-fir-table.md).  
